...
8. docs/adr/002-worker-engines.md
9. docs/adr/004-headless-mcp-inheritance.md
10. docs/adr/009-w5-dashboard-stack-and-deployment.md
...
이번 세션 목표:
- docs/practical-adoption-roadmap.md의 PR 1부터 시작한다.
- pando self-profile과 full daemon smoke contract를 먼저 고정한다.
